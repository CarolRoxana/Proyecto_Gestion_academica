        ...
        <div class="">
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="" style="margin-top: 20%">
                    <h1 class="text-gray-900 dark:text-white"><span style="font-size: 45px; color: blue;">Proyecto - Desarrollo Web</span><span class="ml-4" style="font-size: 50px; color:#1a202c;">Gestion academica</span></h1>
                </div>
                <div>
                @if (Route::has('login'))
                    <div class="hidden text-center px-6 py-4 sm:block">
                        ...
                        @else
                            <a href="{{ route('login') }}" class="ml-4 text-sm text-gray-700 underline" style="color: black">Iniciar sesion</a>
