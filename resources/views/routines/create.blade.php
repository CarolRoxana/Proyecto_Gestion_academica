                        ...
                        <div class="col-md-5 mb-4">
                            <div class="p-3 border bg-light shadow-sm">
                                <form action="{{route('section.routine.store')}}" method="POST">
                                    ...
                                    <div>
                                        <p class="mt-2">Seleccionar seccion:<sup><i class="bi bi-asterisk text-primary"></i></sup></p>
                                    ...
                                    <div class="mt-2">
                                        <p>Dia<sup><i class="bi bi-asterisk text-primary"></i></sup></p>
                                    ...
                                    <div class="mt-2">
                                        <label for="inputStarts" class="form-label">Comienza<sup><i class="bi bi-asterisk text-primary"></i></sup></label>
