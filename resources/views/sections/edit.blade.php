...
<div class="container">
    <div class="row justify-content-start">
        ...
        <div class="col-xs-11 col-sm-11 col-md-11 col-lg-10 col-xl-10 col-xxl-10">
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3"><i class="bi bi-diagram-2"></i> Editar seccion</h1>
                    ...
                    <div class="row">
                        <form class="col-6" action="{{route('school.section.update')}}" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="section_name" class="form-label">Nombre seccion</label>
                                <input class="form-control" id="section_name" name="section_name" type="text" value="{{$section->section_name}}">
                            </div>
                            <div class="mb-3">
                                <label for="room_no" class="form-label">Aula</label>
