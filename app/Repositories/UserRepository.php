    ...
    */
    public function createTeacher($request) {
        try {
            ...
            throw new \Exception('No se pudo crear Teacher. '.$e->getMessage());
        }
    }
    ...
    */
    public function createStudent($request) {
        try {
            ...
            throw new \Exception('No se pudo crear Student. '.$e->getMessage());
        }
    }
    ...
    public function updateStudent($request) {
        try {
            ...
            throw new \Exception('No se pudo actualizar Student. '.$e->getMessage());
        }
    }
    ...
    public function updateTeacher($request) {
        try {
            ...
            throw new \Exception('No se pudo actualizar Teacher. '.$e->getMessage());
        }
    }
    ...
    public function changePassword($new_password) {
        try {
            ...
            throw new \Exception('Failed to Cambiar contrasena. '.$e->getMessage());
        }
    }
}
