...
class UserController extends Controller
{
    ...
    public function storeTeacher(TeacherStoreRequest $request)
    {
        try {
            ...
            return back()->with('status', 'Teacher Registrado correctamente');
        } catch (\Exception $e) {
    ...
    public function storeStudent(StudentStoreRequest $request)
    {
        try {
            ...
            return back()->with('status', 'Student Registrado correctamente');
        } catch (\Exception $e) {
            return back()->withError($e->getMessage());
        }
    }
    ...
    public function updateStudent(Request $request) {
        try {
            ...
            return back()->with('status', 'Student Actualizado correctamente!');
        } catch (\Exception $e) {
            return back()->withError($e->getMessage());
        }
    }
    ...
    public function updateTeacher(Request $request) {
        try {
            ...
            return back()->with('status', 'Teacher Actualizado correctamente!');
        } catch (\Exception $e) {
            return back()->withError($e->getMessage());
        }
    }
