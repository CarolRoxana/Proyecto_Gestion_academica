                ...
                <div class="col ps-4">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{url()->previous()}}">Listado de profesores</a></li>
                    ...
                    <div class="mb-4">
                        <form class="row g-3" action="{{route('school.teacher.update')}}" method="POST">
                            ...
                            <div class="col-3">
                                ...
                                <input type="text" class="form-control" id="inputFirstName" name="first_name" placeholder="Nombre" required value="{{$teacher->first_name}}">
                            </div>
                            <div class="col-3">
                                <label for="inputLastName" class="form-label">Apellido<sup><i class="bi bi-asterisk text-primary"></i></sup></label>
                                <input type="text" class="form-control" id="inputLastName" name="last_name" placeholder="Apellido" required value="{{$teacher->last_name}}">
                            </div>
                            <div class="col-3">
                            ...
                            <div class="col-2">
                                ...
                                <select id="inputState" class="form-select" name="gender" required>
                                    ...
                                    <option value="Female" {{($teacher->gender == 'Female')?'selected':null}}>Femenino</option>
                                </select>
                            </div>
                            <div class="col-3">
                                <label for="inputNationality" class="form-label">Nacionalidad<sup><i class="bi bi-asterisk text-primary"></i></sup></label>
                                <input type="text" class="form-control" id="inputNationality" name="nationality" placeholder="Nacionalidad" required value="{{$teacher->nationality}}">
                            </div>
                            <div class="col-12">
