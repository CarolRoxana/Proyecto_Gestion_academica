...
<div class="container">
    <div class="row justify-content-start">
        ...
        <div class="col-xs-11 col-sm-11 col-md-11 col-lg-10 col-xl-10 col-xxl-10">
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3"><i class="bi bi-file-plus"></i> Crear evaluacion</h1>
                        ...
                        <div class="col-md-5 mb-4">
                            <div class="p-3 border bg-light shadow-sm">
                                <form action="{{route('exam.create')}}" method="POST">
                                    ...
                                    <div>
                                        <p>Seleccionar semestre:<sup><i class="bi bi-asterisk text-primary"></i></sup></p>
                                    ...
                                    <div>
                                        <p class="mt-2">Seleccionar carrera:<sup><i class="bi bi-asterisk text-primary"></i></sup></p>
                                    ...
                                    <div>
                                        <p class="mt-2">Seleccionar materia:<sup><i class="bi bi-asterisk text-primary"></i></sup></p>
                                        <select class="form-select" id="course-select" name="course_id">
                                        </select>
                                    </div>
                                    <div class="mt-2">
                                        <p>Nombre evaluacion<sup><i class="bi bi-asterisk text-primary"></i></sup></p>
                                        <input type="text" class="form-control" name="exam_name" placeholder="Quiz, examen, trabajo ..." aria-label="Quiz, Assignment, Mid term, Final, ...">
                                    </div>
                                    <div class="mt-2">
                                    ...
                                    <div class="mt-2">
                                        <label for="inputEnds" class="form-label">Fin<sup><i class="bi bi-asterisk text-primary"></i></sup></label>
